...
from day4.part_1 import process_events, total_sleep_per_guard, calc_highest_total_sleep_id
...
[1518-11-05 00:55] wakes up"""
    ...
    def test_sleep_totals(self):
        self.assertEqual(self.total_minutes_by_guard, total_sleep_per_guard(self.guard_ids, self.sample_events))

    def sleep_totals_helper(self):
        pass
